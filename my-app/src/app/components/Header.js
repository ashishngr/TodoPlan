...
const Header = () => {
  ...
  return (
    <div className='relative'>
        ...
        {/* Notofication Box */}
        {showNotifications && (
            <div className='absolute right-14 mt-0 w-80 bg-white border border-gray-200 rounded-lg shadow-lg'>
        ...
        {/* User Dropdown */}
        {showUserDropdown && (
            <div className='absolute right-0  bg-white border border-gray-200 rounded-lg shadow-lg'>
            <div className=''>
